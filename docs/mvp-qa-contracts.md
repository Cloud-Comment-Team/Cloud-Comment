...
Все маршруты `/api/sites/{siteId}/automoderation/**` защищены bearer-авторизацией и проверкой владения сайтом. `GET /api/sites/{siteId}/automoderation/policies` возвращает единый envelope:
